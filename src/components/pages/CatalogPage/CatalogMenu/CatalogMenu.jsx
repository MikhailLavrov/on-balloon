...
export const CatalogMenu = ({style, handleMenuClick, theme}) => {
  ...
  const [openKeys, setOpenKeys] = useState(
    [currentTopCollectionState && currentTopCollectionState !== '' ? currentTopCollectionState : catalogMenuData[1].key]
    );
  ...
  const defaultSelectedKeys = currentTopCollectionState && currentTopCollectionState !== '' 
    ? [catalogMenuData.find(item => item.key === currentTopCollectionState).children[0].key]
